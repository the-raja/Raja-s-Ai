...
const PROJECTS: Project[] = [
    {
        ...
        live: "https://github.com/the-raja/AI-Map",
    },
    {
        id: 2,
        icon: "⚔️",
        ...
        github: "https://github.com/the-raja/yseek",
        live: "https://github.com/the-raja/yseek",
    },
    {
        id: 3,
        icon: "🤖",
        ...
        >
            ...
            >
                ...
                <div className="flex flex-wrap gap-2.5 mb-8">
                    ...
                    <a
                        href="https://the-raja.vercel.app/"
                        target="_blank"
                        rel="noreferrer"
                        className="text-[12px] font-medium flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/[0.05] border border-white/[0.05] text-white/80 hover:bg-[#28C840]/15 hover:border-[#28C840]/30 hover:text-[#28C840] transition-all shadow-sm"
                    >
                        <svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="opacity-70"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1 4-10z"></path></svg>
                        Portfolio ↗
                    </a>
                </div>
